(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.powtcha = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
(function (Buffer){
module.exports = {
    Buffer: Buffer,
...
},{"./lib/powtcha":5,"buffer":9}],2:[function(require,module,exports){
...
},{"./sha256":3}],3:[function(require,module,exports){
/* jshint -W064,-W071 */
 ...
 *  Original code by Angel Marin, Paul Johnston of http://www.webtoolkit.info/
 *
 *  Modified by https://github.com/progranism/Bitcoin-JavaScript-Miner
 *
 *  Then Modified by Ruben de Vries
 **/

var SHA_256_INITIAL_STATE = new Uint32Array([0x6A09E667, 0xBB67AE85, 0x3C6EF372, 0xA54FF53A, 0x510E527F, 0x9B05688C, 0x1F83D9AB, 0x5BE0CD19]);
...
function sha256_chunk(state, data) {
    ...
    for (var j = 0; j < 64; ++j) {
        ...
        var t1 = safe_add(safe_add(safe_add(safe_add(h, s1), ch), K[j]), W[j]);
    ...
    b = safe_add(state[1], b);
    c = safe_add(state[2], c);
    d = safe_add(state[3], d);
    e = safe_add(state[4], e);
    f = safe_add(state[5], f);
    g = safe_add(state[6], g);
    h = safe_add(state[7], h);

    return new Uint32Array([a, b, c, d, e, f, g, h]);
}

function sha256_prepare(data) {
    if (!(data instanceof Uint8Array)) {
        throw new Error("data must be Uint8Array");
    }

    if (data.length > 56) {
        throw new Error("data must be length <= 56");
    }

    // add trailing '1' bit
    var newData = new Uint8Array(data.length + 1);
    newData.set(data);
    newData.set(new Uint8Array([0x80]), data.length);

    var res = new Uint32Array(16);
    res.set(util.Uint32ArrayFromBuffer(newData));

    // add length (in bits) into final pair of 32-bit integers (big-endian)
    // note: most significant word would be (len-1)*8 >>> 32, but since JS converts
    // bitwise-op args to 32 bits, we need to simulate this by arithmetic operators
    var lenHi = ((data.length) * 8) / Math.pow(2, 32);
    var lenLo = ((data.length) * 8) >>> 0;

    res[14] = Math.floor(lenHi);
    res[15] = lenLo;
...
module.exports = exports = {
    SHA_256_INITIAL_STATE: SHA_256_INITIAL_STATE,
    sha256_prepare: sha256_prepare,
...
},{"./miner/miner":2,"./miner/sha256":3,"./miner/util":4,"./webworkifier":7,"buffer":9,"es6-promise":10}],6:[function(require,module,exports){
(function (Buffer){
var miner = require('./miner/miner');
...
},{"./miner/miner":2,"buffer":9}],7:[function(require,module,exports){
(function (process){
...
},{"./webworker":6,"_process":13,"es6-promise":10,"webworkify":14}],8:[function(require,module,exports){
'use strict'
